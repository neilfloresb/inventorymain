...
const WEBapiURLcore = 'http://localhost:5270/';
...
export class mapapi {
  ...
  public static itemMaster: string =
    apiUrl + '/api/itemmaster'
  public static supplier: string =
    apiUrl + '/api/supplier'
  public static purchaseOrder: string =
    apiUrl + '/api/purchaseOrder'
  public static branchname: string =
    apiUrl + '/api/branchname'
  public static bankname: string =
    apiUrl + '/api/bankhname'
  public static paybables: string =
    apiUrl + '/api/payables'
  public static payDetailPO: string =
    apiUrl + '/api/payableDetail'      // with po_no parameters
  public static payableDetailPOs: string =
    apiUrl + '/api/payableDetailPOs'
}
